...
export const TopChart = () => {
  ...
  const ptp = [
    { x: 'Jan 22', y: 100000 * 0.75 },
    { x: 'Feb 22', y: 112244 * 0.75 },
    { x: 'Mar 22', y: 232211 * 0.75 },
    { x: 'Apr 22', y: 175000 * 0.75 },
    { x: 'May 22', y: 213133 * 0.75 },
  ];

  const collected = [
    { x: 'Jan 22', y: 100000 * 0.63 },
    { x: 'Feb 22', y: 112244 * 0.63 },
    { x: 'Mar 22', y: 232211 * 0.63 },
    { x: 'Apr 22', y: 175000 * 0.63 },
    { x: 'May 22', y: 213133 * 0.63 },
  ];
